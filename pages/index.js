...
export default function Home({ products, categories }) {
  ...
  if (state) {
    toast(<div  >
      ...
      <button onClick={() => { Router.push('/account'); dispatch(setStep('c')) }}
        className="z-50 flex text-sm font-extralight justify-center ">
  ...
  return (
    <div className=" no-scrollbar  overflow-x-hidden">
      <Head>
        ...
        <meta name="description" content="amazon web app made by "></meta>
      </Head>
